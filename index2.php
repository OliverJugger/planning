  ...
  <div class="container-fluid" style = "height : 70%; width :70%;">
    <header>
      <div class="row" style="margin:auto;">
        <button class="btn-info" style="height:70%; margin-top:10px; margin-left:30%; margin-right:20px;"><a href="index.php" class="button" style="color:white;"><i class="fas fa-arrow-left"></i></a></button>
        <h4 class="display-4 mb-4 text-center" style="font-size:2em;">Semaine Impaire</h4>        
      </div>
...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalSupprimer" style="position:absolute;bottom:3%;left:5.5%;">
  ...
  <!-- Button trigger modal -->
<button type="button" class="btn btn-success"  data-toggle="modal" data-target="#exampleModalQuelquun" style="position:absolute;bottom:3%;left:10.5%;">
  Nouvelle personne
</button>

  <!-- Button trigger modal -->
<button id="screenshot" type="button" class="btn btn-dark" style="position:absolute;bottom:3%;left:22%;">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-signin" action="impair/post_ajouter.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="exampleModalSupprimer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-signin" action="impair/post_supprimer.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">          
            <select style="margin-top : 10px;" name="nom">
              <option value="">Qui ?</option>
              <?php
...
<div class="modal fade" id="exampleModalQuelquun" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-signin" action="impair/post_ajouter_quelqun.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
        ...
        html2canvas(screenshotTarget).then((canvas) => {
         ...
         var base64URL = canvas.toDataURL('image/jpeg').replace('image/jpeg', 'image/octet-stream');
            ...
            $.ajax({
               ...
               method: "POST",
               dataType: "json",
               data: {image: base64image,semaine:'impair'},
